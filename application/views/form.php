...
<head>
    <script src="<?php echo ASSET_WEB_PATH;?>js/w3color.js"></script>
    <meta charset="UTF-8">
    ...
    <form action="<?php echo base_url('form/saveData');?>" method="post" class="container addMargin" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-8">
                ...
                <div id="steps">
                    <div class="step active " data-desc="Listing information">1</div>
        ...
        <div class="row">
            <div class=" col-xl-9 p-3">
                ...
                <div class="boxWrap">
                    ...
                    <div class="boxDetaile boxDetaile1 activeSlide">
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                ...
                                <div class="col-12 my-3">
                                    <input type="text" placeholder="Email Id" class="inputfield" id="mailContact"
                                        name="mail" value="<?php echo isset($res['email'])?$res['email']:''; ?>">
                                </div>
                                <div class="col-12 my-3">
                                    <input type="text" placeholder="Company Name" class="inputfield" id="companyName"
                                        name="companyName" value="<?php echo isset($res['company_name'])?$res['company_name']:''; ?>" required>
                                    <p>(optional)</p>
                                </div>
                    ...
                    <div class="boxDetaile boxDetaile2">
                        <div class="leftSide">
                        ...
                        <div class="centerSide">
                            <div action="#" class="d-flex flex-wrap align-items-center printable">
                                ...
                                <div class="col-12 my-3">
                                    <select id="Papersize" onclick="createPagenameDDL();" name="banner_id" required>
                                        <?php if($listAr!='' && !empty($listAr))
                                        {
                                        foreach ($listAr as $key => $value) {
                                            ?>
                                        <option value="<?php echo $value['banner_id'];?>"><?php echo $value['b_name'];?></option>
                                      <?php } } ?>
                                    </select>
                                </div>

                                <div class="col-12 my-3">
                                    <select id="type_id" name="t_size_type_id" onclick="showprice()" required>
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <div class="col-12 my-3">
                                    <select id="printable_type" name="printable_type" >
                                ...
                                <div class="col-12 my-3 hideThis">
                                    ...
                                    <input type="text" placeholder="Custom Size" id="customSize" readonly>
                                </div>

                                <div class="col-md-6 col-12 my-3 pe-4 hideThis">
                                    <input type="number" placeholder="Width" id="customWidth">
                                </div>
                                ...
                                <div class="col-md-6 col-12 my-3 pe-4 hideThis">
                                    <input type="number" placeholder="Height" id="customHeight">
                                </div>
                                <div class="col-md-6 hideThis">
                                    <div class="buttonsSize">
                                        <div>
                                ...
                                <div class="col-lg-6 col-12 my-3 hideThis">
                                    <input type="radio" name="orientation" id="width">
                                ...
                                <div class="col-lg-6 col-12 my-3 hideThis">
                                    <input type="radio" name="orientation" id="height">
                                ...
                                <div>
                                    ...
                                    <div class="dragDrop dropZone">
                                        ...
                                        <label for="uploadLogoInput">
                                            <input type="file" name="uploadlogo" id="uploadLogoInput"
                                ...
                                <div>
                                    ...
                                    <div class="dragDrop dropZone">
                                        ...
                                        <label for="uploadspecific">
                                            <input type="file" name="uploadlogo" id="uploadspecific"
                                                class="dropZoneInput" data-no="0">
                                            Select Files
                                        </label>
                                        <p>
                ...
                <div class="price">
                    ...
                    <table>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th>
                                    <span class="badge bg-secondary" id="showRixicoin">
...
document.getElementById('costvalue').innerHTML=obj.cost;
document.getElementById('costvaluep').innerHTML=obj.cost;
document.getElementById('total').innerHTML=obj.cost;
...
document.getElementById('paperSizeOutput').value=obj.title;
    ...
    <script>
        let selectedValue = document.querySelector('#Papersize')
        selectedValue.addEventListener('input', function () {
            let selectedValueOption = document.querySelector('#Papersize').value
            if (selectedValueOption === 'Custom') {
