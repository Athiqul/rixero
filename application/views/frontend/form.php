  ...
  <?php $this->load->view('frontend/header');?>
    ...
    <?php
        ...
        <div class="row justify-content-center">
                ...
                <div class="boxWrap">
                    ...
                    <div class="boxDetaile boxDetaile1 activeSlide"<?php if($user_id>0){ ?> style="display: none" <?php }?>>
                        ...
                        <div class="centerSide">
                            <div class="col-md-12 col-12 position-relative overflow-hidden" >
                 <form action="<?php echo site_url('login/checkuserlogin'); ?>" class="container addMargin" method="post">

                    <div class="loginForm login" style="margin-top:-23%">
                        <div>
                            <h3> Login</h3>
                            <p>
               ...
               <form action="<?php echo CUSTOMER_SAVE_REGISTRATION_URL;?>" method='post'>
                    <div class="loginForm signup" >
                       ...
                       <div class="my-3">
                        ...
                        <div class="my-3">
                            <input type="email"  name="email" placeholder="Email" style="background-image: url(&quot;data:image/png;base64,&quot;) !important; background-repeat: no-repeat; background-size: 20px; background-position: 97% center; cursor: auto;"
            ...
            <div class=" col-xl-3 p-3" <?php if($user_id<=0){ ?> style="display: none" <?php }?>>
                <div class="price">
...
$('.login').css("margin-top", "-23%");
            $('.signup').css("margin-top", "0px");
