...
<body>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-9">
            <ul class="navigationArea">
             <li><a href="<?php echo base_url();?>">Home</a></li>
                <li><a href="<?php echo FRONTEND_OUR_WORK_URL; ?>">Our Work</a></li>
                <li><a href="<?php echo base_url('work'); ?>">Our Services</a></li>
        ...
        { 
            ...
            ?>
                <li><a class="dashboardcss" href="<?php echo base_url('admin/dashboard');?>" class="loginButton"><?php echo isset($res['first_name'])?$res['first_name']:''; ?><?php //echo isset($res['last_name'])?$res['last_name']:''; ?></a>
    ...
    color: #00f2a6;'></i> <span></span></a></li>
        ...
        <?php } else { ?>
                <li><a href="<?php echo base_url('login');?>" class="loginButton" style="border-radius:5px">Login</a></li>
            <?php } ?>
