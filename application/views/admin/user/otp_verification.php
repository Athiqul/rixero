	...
	<body>
		...
		<div class="padding-15">
			...
			<div class="login-box">
				...
				<!-- password form -->
				<form action="<?php echo ADMIN_OTP_VERIFICATION_DETAILS_SUBMIT_URL; ?>" method="post" class="sky-form boxed ">
					<header><i class="fa fa-key"></i> <b>Please enter the 6-digit verification code</b></header>
					
					<fieldset>	
						<!-- ERROR MESSAGE START -->
						<?php $this->load->view('admin/component/dismissible_message'); ?>
						<!-- ERROR MESSAGE END -->
						<label class="label"><strong>OTP</strong></label>
						<label class="input">
							<i class="icon-append"></i>
							<input type="text" name="email_otp_verification" id="email_otp_verification" minlength="6" maxlength="6" pattern="[0-9]+" title="Please Enter Otp" placeholder="Enter Otp..." required="required">
							<span class="tooltip tooltip-top-right">Type your Otp</span>
						</label>
						<a href="<?php echo ADMIN_FORGET_PASSWORD_DETAILS_URL; ?>"><b>Back to Email</b></a>

					</fieldset>

					<footer>
						<input type="hidden" name="user_id" id="user_id"  value="<?php echo $user_id; ?>">
						<button type="submit" class="btn btn-primary pull-right"><i class="fa fa-key"></i> Confirm</button>
					</footer>
				</form>
				<!-- /password form -->
