...
class Work extends CI_Controller {
	...
	public function index()
	{
		...
		$data['printableAr']=$this->getourWork('1');
		$data['nonprintableAr']=$this->getourWork('2');
		$data['socialAr']=$this->getourWork('3');
		$data['websiteAr']=$this->getourWork('4');
		$data['workAr']=$workAr=$this->getallwork('');
		// echo $this->db->last_query();
		// print_r($workAr); die();
		$this->load->view('frontend/ourWork',$data);
	}


	public function getourWork($banner_id=0)
	{
		$this->db->select();
